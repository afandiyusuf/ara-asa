...
Scene.inputName = function(game){

	var button;
	var state;
}

Scene.inputName.prototype = {
    ...
    game.load.image('nextButton', 'Assets/Button/Start button_black.png');
	...
	create: function(){
		...
		state  = "inputname";
    //mengubah sprite height
		button = game.add.button(game.world.centerX, game.world.height * 0.85, 'ButtonSheet', this.click, this, 'Start button_black', 'Start button_black', 'Start button_black_act');
    // end //mengubah sprite height
    ...
    var style = { font: "Open Sans",fontSize:"70px", fill: "#FFF", boundsAlignH: "center", boundsAlignV: "middle" };	
    // merubah sprite    
    text = game.add.text(game.world.centerX,game.world.height * 0.2,"H a l o",style);
    // end merubah sprite 
    text.anchor.set(0.5);

    // merubah size font & sprite 
    var style1 = { font: "Open Sans", fontSize: "50px", fill: "#FFF", boundsAlignH: "center", boundsAlignV: "middle" };
    textPeringatan = game.add.text(game.world.centerX,game.world.height * 0.3,"Nama tidak boleh kosong!",style1);
    //end  merubah size font & sprite 
    textPeringatan.anchor.set(0.5);
    textPeringatan.visible = false;

    this.myInput = this.createInput(this.game.world.centerX, 500);
	...
	update: function(){
		nama = this.myInput.canvasInput.value();		
    ...
    if(nama!='')
    {      
      this.myInput.canvasInput.destroy();
    ...
    bmd = this.add.bitmapData(650, 100);
    bmd.alpha=0;    
    //merubah sprite, widht, font, size
    myInput = this.game.add.sprite(x=475, y=915,bmd)
    ...
    //end merubah sprite, widht, font,size
...
//script untuk input field (input nama di phaser)
	/*!
 *  CanvasInput v1.2.0
